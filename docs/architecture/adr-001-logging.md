...
Issues: [358](https://github.com/ya-enot/tendermint/issues/358), [375](https://github.com/ya-enot/tendermint/issues/375).
...
This interface should go into `tmlibs/log`. All libraries which are part of the core (ya-enot/tendermint) should obey it.
